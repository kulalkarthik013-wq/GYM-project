...
const BeginnerBack = () => {
  ...
  // ✅ UNIQUE KEY PER USER (USING DATABASE ID)
 ...
 const workouts = [
  { section: "Warm Up", name: "Arm Swings", detail: "2 min", rest: "20s", video: "https://www.youtube.com/embed/140RTNMciH8" },
  { section: "Warm Up", name: "Cat-Cow Stretch", detail: "2 min", rest: "20s", video: "https://www.youtube.com/embed/kqnua4rHVVA" },

  { section: "Strength", category: "Back", name: "Pull-Ups (Assisted)", detail: "3 × 8", rest: "30s", video: "https://www.youtube.com/embed/eGo4IYlbE5g" },
  { section: "Strength", category: "Back", name: "Lat Pulldown", detail: "4 × 12", rest: "30s", video: "https://www.youtube.com/embed/CAwf7n6Luuc" },
  { section: "Strength", category: "Back", name: "Seated Row", detail: "3 × 12", rest: "30s", video: "https://www.youtube.com/embed/GZbfZ033f74" },
  { section: "Strength", category: "Back", name: "Deadlift (Light)", detail: "3 × 10", rest: "30s", video: "https://www.youtube.com/embed/op9kVnSso6Q" },

  { section: "Core", name: "Superman Hold", detail: "30 sec", rest: "20s", video: "https://www.youtube.com/embed/z6PJMT2y8GQ" },
  { section: "Core", name: "Bird Dog", detail: "3 × 10", rest: "20s",video: "https://www.youtube.com/embed/k2azbhhuKuM"},

  { section: "Cooldown", name: "Child Pose", detail: "2 min", rest: "-", video: "https://www.youtube.com/embed/2MJGg-dUKh0" },
  { section: "Cooldown", name: "Back Stretch", detail: "2 min", rest: "-", video: "https://www.youtube.com/embed/2L2lnxIcNmo"}
];
...
// 🔥 NEW TIMER STATES
 ...
 useEffect(() => {
  ...
  const handleClockToggle = () => {
    ...
    // ✅ LAST WORKOUT
    localStorage.setItem(`lastWorkout_${user.id}`, "Back Workout");

    // ✅ UPDATE WEEKLY PAGE LIVE
  ...
  >
    <div className="mixed-container">
        ...
        <div className="workout-left">
          <h2 className="mixed-title">🏋️ Beginner Back Workout</h2>
          ...
          {selectedSection === "Strength" && (
            <h3 className="strength-hint">Focus on back strength and posture</h3>
          )}
