...
const CyclingEndurance = () => {
  ...
  const workouts = [
    { section: "Warm Up", name: "Slow Pedaling", detail: "5 min", rest: "-" },
    { section: "Warm Up", name: "Leg Stretch", detail: "3 min", rest: "-" },

    { section: "Ride", category: "Endurance", name: "Steady Cycling", detail: "15 min", rest: "-" },
    { section: "Ride", category: "Endurance", name: "High Speed Cycling", detail: "5 min", rest: "1 min" },
    { section: "Ride", category: "Endurance", name: "Hill Climb (Resistance)", detail: "5 min", rest: "1 min" },
    { section: "Ride", category: "Endurance", name: "Sprint Ride", detail: "30 sec", rest: "1 min" },

    { section: "Core", name: "Plank", detail: "45 sec", rest: "20s" },
    { section: "Core", name: "Crunches", detail: "3 × 20", rest: "20s" },

    { section: "Cooldown", name: "Slow Cycling", detail: "5 min", rest: "-" },
    { section: "Cooldown", name: "Stretching", detail: "3 min", rest: "-" }
  ];
  ...
  const goalTime = 2400; // ⏱ 40 mins cycling
  ...
  const handleClockToggle = () => {
    ...
    // ✅ FIXED LAST WORKOUT KEY
    localStorage.setItem(`lastWorkout_user_${user.id}_endurance`, "Cycling");
    ...
    <DashboardLayout>
      <div className="mixed-container">
        ...
        <div className="workout-left">
          <h2 className="mixed-title">🚴 Cycling Endurance</h2>

          <div className="section-buttons">
            <button onClick={() => setSelectedSection("Warm Up")}>Warm Up</button>
            <button onClick={() => setSelectedSection("Ride")}>Ride</button>
          ...
          {selectedSection === "Ride" && (
            <h3 className="strength-hint">
              Build leg endurance 🚴 push your limits
            </h3>
          )}
...
export default CyclingEndurance;