...
const FullBodyBurn = () => {
  ...
  const workouts = [
    ...
    { section: "Warm Up", name: "Arm Circles", detail: "2 min", rest: "20s" },

    { section: "Full Body", category: "Strength", name: "Squats", detail: "3 × 12", rest: "20s" },
    { section: "Full Body", category: "Strength", name: "Push Ups", detail: "3 × 10", rest: "20s" },
    { section: "Full Body", category: "Strength", name: "Lunges", detail: "3 × 10 each", rest: "20s" },
    { section: "Full Body", category: "Strength", name: "Plank", detail: "30 sec", rest: "20s" },
    { section: "Full Body", category: "Strength", name: "Mountain Climbers", detail: "30 sec", rest: "20s" },

    { section: "Cardio", category: "Fat Burn", name: "Burpees", detail: "30 sec", rest: "15s" },
    { section: "Cardio", category: "Fat Burn", name: "High Knees", detail: "30 sec", rest: "15s" },
    { section: "Cardio", category: "Fat Burn", name: "Jump Squats", detail: "30 sec", rest: "15s" },

    { section: "Cooldown", name: "Full Body Stretch", detail: "2 min", rest: "-" },
  ...
  const handleClockToggle = () => {
    ...
    // ✅ UPDATE LAST WORKOUT
    localStorage.setItem(`lastWorkout_${user.id}`, "Full Body Burn");
