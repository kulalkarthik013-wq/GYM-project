...
const BeginnerCardio = () => {
 ...
 const workouts = [
  { section: "Warm Up", name: "March in Place", detail: "2 min", rest: "20s", video: "https://www.youtube.com/embed/gC_L9qAHVJ8" },
  { section: "Warm Up", name: "Arm Swings", detail: "2 min", rest: "20s", video: "https://www.youtube.com/embed/140RTNMciH8" },

  { section: "Cardio", category: "Cardio", name: "Jump Rope", detail: "3 × 2 min", rest: "30s",video: "https://www.youtube.com/embed/u3zgHI8QnqE" },
  { section: "Cardio", category: "Cardio", name: "High Knees", detail: "3 × 1 min", rest: "30s", video: "https://www.youtube.com/embed/OAJ_J3EZkdY" },
  { section: "Cardio", category: "Cardio", name: "Burpees", detail: "3 × 10", rest: "30s", video: "https://www.youtube.com/embed/TU8QYVW0gDU" },
  { section: "Cardio", category: "Cardio", name: "Mountain Climbers", detail: "3 × 20", rest: "30s", video: "https://www.youtube.com/embed/nmwgirgXLYM" },
  ...
  { section: "Cooldown", name: "Walking", detail: "2 min", rest: "-", video: "https://www.youtube.com/embed/enYITYwvPAQ" },
  { section: "Cooldown", name: "Full Body Stretch", detail: "2 min", rest: "-", video: "https://www.youtube.com/embed/v7AYKMP6rOE" }
];
...
// 🔥 NEW TIMER STATES
  ...
  const handleClockToggle = () => {
    ...
    // ✅ LAST WORKOUT
    localStorage.setItem(`lastWorkout_${user.id}`, "Cardio Workout");
  ...
  >
    <div className="mixed-container">
        ...
        <div className="workout-left">
          <h2 className="mixed-title">🏃 Beginner Cardio Workout</h2>
          ...
          {selectedSection === "Cardio" && (
            <h3 className="strength-hint">Focus on endurance & stamina</h3>
          )}
