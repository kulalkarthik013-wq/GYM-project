...
const BeginnerChest = () => {
 ...
 const workouts = [
  ...
  { section: "Warm Up", name: "Push-Ups (Easy)", detail: "2 x 10", rest: "20s", video: "https://www.youtube.com/embed/IODxDxX7oi4" },

  { section: "Strength", category: "Chest", name: "Flat Bench Press", detail: "4 × 12", rest: "30s", video: "https://www.youtube.com/embed/rT7DgCr-3pg" },
  { section: "Strength", category: "Chest", name: "Incline Dumbbell Press", detail: "3 × 12", rest: "30s", video: "https://www.youtube.com/embed/8iPEnn-ltC8" },
  { section: "Strength", category: "Chest", name: "Chest Fly", detail: "3 × 15", rest: "30s", video: "https://www.youtube.com/embed/eozdVDA78K0" },
  { section: "Strength", category: "Chest", name: "Dips", detail: "3 × 10", rest: "30s", video: "https://www.youtube.com/embed/2z8JmcrW-As" },
  ...
  { section: "Cooldown", name: "Chest Stretch", detail: "2 min", rest: "-", video: "https://www.youtube.com/embed/6pKKnVg1hzE" },
  { section: "Cooldown", name: "Cobra Stretch", detail: "2 min", rest: "-",video: "https://www.youtube.com/embed/JDcdhTuycOI" }
];
 ...
 useEffect(() => {
  ...
  const handleClockToggle = () => {
    ...
    // ✅ LAST WORKOUT
    localStorage.setItem(`lastWorkout_${user.id}`, "Chest Workout");
  ...
  >
    <div className="mixed-container">
        ...
        <div className="workout-left">
          <h2 className="mixed-title">💪 Beginner Chest Workout</h2>
          ...
          {selectedSection === "Strength" && (
            <h3 className="strength-hint">Focus on chest strength</h3>
          )}
