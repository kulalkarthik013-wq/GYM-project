...
const BeginnerBiceps = () => {
  ...
  // ✅ UNIQUE STORAGE PER USER (USING ID)
  ...
  { section: "Warm Up", name: "Light Dumbbell Curl", detail: "2 x 12", rest: "20s", video: "https://www.youtube.com/embed/ykJmrZ5v0Oo" },

  { section: "Strength", category: "Biceps", name: "Dumbbell Curl", detail: "4 × 12", rest: "30s", video: "https://www.youtube.com/embed/ykJmrZ5v0Oo" },
  { section: "Strength", category: "Biceps", name: "Hammer Curl", detail: "3 × 12", rest: "30s", video: "https://www.youtube.com/embed/zC3nLlEvin4" },
  { section: "Strength", category: "Biceps", name: "Concentration Curl", detail: "3 × 10", rest: "30s", video: "https://www.youtube.com/embed/soxrZlIl35U" },
  { section: "Strength", category: "Biceps", name: "Barbell Curl", detail: "3 × 10", rest: "30s", video: "https://www.youtube.com/embed/kwG2ipFRgfo" },
  ...
  const handleClockToggle = () => {
    ...
    // ✅ LAST WORKOUT
    localStorage.setItem(`lastWorkout_${user.id}`, "Biceps Workout");
  ...
  >
    <div className="mixed-container">
        ...
        <div className="workout-left">
          <h2 className="mixed-title">🦾 Beginner Biceps Workout</h2>
          ...
          {selectedSection === "Strength" && (
            <h3 className="strength-hint">Focus on biceps strength</h3>
          )}
