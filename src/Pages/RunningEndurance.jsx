...
const RunningEndurance = () => {
  ...
  const workouts = [
    { section: "Warm Up", name: "Brisk Walking", detail: "5 min", rest: "-" },
    { section: "Warm Up", name: "Dynamic Stretch", detail: "3 min", rest: "-" },

    { section: "Run", category: "Endurance", name: "Jogging", detail: "10 min", rest: "1 min" },
    { section: "Run", category: "Endurance", name: "Sprint", detail: "30 sec", rest: "1 min" },
    { section: "Run", category: "Endurance", name: "Steady Run", detail: "10 min", rest: "-" },
    { section: "Run", category: "Endurance", name: "Incline Run", detail: "5 min", rest: "1 min" },

    { section: "Core", name: "Plank", detail: "45 sec", rest: "20s" },
    { section: "Core", name: "Leg Raises", detail: "3 × 15", rest: "20s" },

    { section: "Cooldown", name: "Walking", detail: "5 min", rest: "-" },
  ...
  const goalTime = 2400; // ⏱ 40 mins running
  ...
  const handleClockToggle = () => {
    ...
    localStorage.setItem(`lastWorkout_user_${user.id}_endurance`, "Running");
    ...
    <DashboardLayout>
      <div className="mixed-container">
        ...
        <div className="workout-left">
          <h2 className="mixed-title">🏃 Running Endurance</h2>

          <div className="section-buttons">
            <button onClick={() => setSelectedSection("Warm Up")}>Warm Up</button>
            <button onClick={() => setSelectedSection("Run")}>Run</button>
...
export default RunningEndurance;