...
const BeginnerTriceps = () => {
  ...
  { section: "Warm Up", name: "Light Tricep Extensions", detail: "2 x 12", rest: "20s", video: "https://www.youtube.com/embed/YbX7Wd8jQ-Q" },

  { section: "Strength", category: "Triceps", name: "Tricep Dips", detail: "4 × 10", rest: "30s", video: "https://www.youtube.com/embed/0326dy_-CzM" },
  { section: "Strength", category: "Triceps", name: "Overhead Tricep Extension", detail: "3 × 12", rest: "30s", video: "https://www.youtube.com/embed/YbX7Wd8jQ-Q" },
  { section: "Strength", category: "Triceps", name: "Tricep Pushdown", detail: "3 × 12", rest: "30s", video: "https://www.youtube.com/embed/2-LAMcpzODU" },
  { section: "Strength", category: "Triceps", name: "Close Grip Push-Ups", detail: "3 × 10", rest: "30s", video: "https://www.youtube.com/embed/IODxDxX7oi4" },

  { section: "Core", name: "Plank", detail: "30 sec", rest: "20s", video: "https://www.youtube.com/embed/pSHjTRCQxIw" },
  { section: "Core", name: "Mountain Climbers", detail: "3 × 20", rest: "20s", video: "https://www.youtube.com/embed/nmwgirgXLYM" },

  { section: "Cooldown", name: "Triceps Stretch", detail: "2 min", rest: "-", video: "https://www.youtube.com/embed/2MJGg-dUKh0" },
  { section: "Cooldown", name: "Arm Stretch", detail: "2 min", rest: "-", video: "https://www.youtube.com/embed/3VcKaXpzqRo" }
];
  ...
  const handleClockToggle = () => {
    ...
    // ✅ LAST WORKOUT
    localStorage.setItem(`lastWorkout_${user.id}`, "Triceps Workout");
  ...
  >
    <div className="mixed-container">
        ...
        <div className="workout-left">
          <h2 className="mixed-title">💥 Beginner Triceps Workout</h2>
...
export default BeginnerTriceps;