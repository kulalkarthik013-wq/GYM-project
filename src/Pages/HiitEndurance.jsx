...
const HiitEndurance = () => {
  ...
  // ✅ WORKOUT LIST (ENDURANCE VERSION)
  const workouts = [
    { section: "Warm Up", name: "Jumping Jacks", detail: "2 min", rest: "20s" },
    { section: "Warm Up", name: "High Knees", detail: "1 min", rest: "20s" },

    { section: "HIIT", category: "Endurance", name: "Burpees", detail: "30 sec", rest: "15s" },
    { section: "HIIT", category: "Endurance", name: "Mountain Climbers", detail: "30 sec", rest: "15s" },
    { section: "HIIT", category: "Endurance", name: "Jump Rope", detail: "45 sec", rest: "15s" },
    { section: "HIIT", category: "Endurance", name: "High Knees Sprint", detail: "30 sec", rest: "15s" },
    { section: "HIIT", category: "Endurance", name: "Skaters", detail: "30 sec", rest: "15s" },

    { section: "Core", name: "Plank", detail: "45 sec", rest: "20s" },
    { section: "Core", name: "Bicycle Crunch", detail: "3 × 20", rest: "20s" },

    { section: "Cooldown", name: "Hamstring Stretch", detail: "2 min", rest: "-" },
  ...
  const handleClockToggle = () => {
    ...
    // ✅ UPDATE LAST WORKOUT (IMPORTANT FIX)
    localStorage.setItem(`lastWorkout_user_${user.id}_endurance`, "HIIT Endurance");
    ...
    alert("Endurance workout logged!");
  };
    ...
    <DashboardLayout>
      <div className="mixed-container">
        ...
        <div className="workout-left">
          <h2 className="mixed-title">🔥 HIIT Endurance Workout</h2>
          ...
          {selectedSection === "HIIT" && (
            <h3 className="strength-hint">
              Build stamina ⚡ push your limits
            </h3>
          )}
