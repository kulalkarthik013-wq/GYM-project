...
const HiitFatBurn = () => {
  ...
  const workouts = [
    ...
    { section: "Warm Up", name: "High Knees", detail: "1 min", rest: "20s", video: "https://www.youtube.com/embed/OAJ_J3EZkdY" },

    { section: "HIIT", category: "Fat Burn", name: "Burpees", detail: "30 sec", rest: "15s", video: "https://www.youtube.com/embed/dZgVxmf6jkA" },
    { section: "HIIT", category: "Fat Burn", name: "Mountain Climbers", detail: "30 sec", rest: "15s", video: "https://www.youtube.com/embed/nmwgirgXLYM" },
    { section: "HIIT", category: "Fat Burn", name: "Jump Squats", detail: "30 sec", rest: "15s", video: "https://www.youtube.com/embed/A-cFYWvaHr0" },
    { section: "HIIT", category: "Fat Burn", name: "Push Ups", detail: "30 sec", rest: "15s", video: "https://www.youtube.com/embed/IODxDxX7oi4" },
    { section: "HIIT", category: "Fat Burn", name: "Plank Jacks", detail: "30 sec", rest: "15s", video: "https://www.youtube.com/embed/Pr1ieGZ5atk" },
   ...
   { section: "Cooldown", name: "Slow March in Place", detail: "2 min", rest: "-", video: "https://www.youtube.com/embed/I5OUSypZVIc" },
   { section: "Cooldown", name: "Arm Circles (Slow)", detail: "2 min", rest: "-", video: "https://www.youtube.com/embed/vTx_ldn6MCA" }
  ];
  ...
  const handleClockToggle = () => {
    ...
    localStorage.setItem(`lastWorkout_${user.id}`, "HIIT Fat Burn");
      ...
      >
        <div className="mixed-container">
          ...
          <div className="workout-left">
            <h2 className="mixed-title">🔥 HIIT Fat Burn Workout</h2>

            <div className="section-buttons">
              <button onClick={() => setSelectedSection("Warm Up")}>Warm Up</button>
              <button onClick={() => setSelectedSection("HIIT")}>HIIT</button>
              <button onClick={() => setSelectedSection("Core")}>Core</button>
              <button onClick={() => setSelectedSection("Cooldown")}>Cooldown</button>
            </div>

            {selectedSection === "HIIT" && (
              <h3 className="strength-hint">High intensity fat burning 🔥</h3>
            )}
